          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-center lg:text-left">
              ...
              >
                ...
                <div class="flex items-center gap-2">
                  <Icon name="ph:credit-card" class="w-5 h-5 text-success" />
            ...
            <div class="grid grid-cols-2 gap-6">
              ...
              >
                <div class="text-4xl font-bold text-primary-foreground mb-2">
                  €800+
                </div>
              ...
              >
                ...
                <div class="text-primary-foreground/80">
                  Keep from your private bookings
                </div>
              </div>
              <div
                class="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-6 border border-primary-foreground/20"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-muted rounded-xl p-8">
            <Icon name="ph:video-camera" class="w-12 h-12 text-primary mb-6" />
            ...
            <div class="mt-6 pt-6 border-t border-border">
              ...
              <div class="text-2xl font-bold text-primary">€800+</div>
            </div>
          </div>
          ...
          <div class="bg-muted rounded-xl p-8">
            ...
            <div class="mt-6 pt-6 border-t border-border">
              ...
              <div class="text-2xl font-bold text-primary">€1200+</div>
            </div>
          </div>

          <div class="bg-muted rounded-xl p-8">
            <Icon name="ph:megaphone" class="w-12 h-12 text-primary mb-6" />
    ...
    <section class="py-16 bg-muted">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="p-6 bg-background rounded-xl">
            <Icon name="ph:storefront" class="w-8 h-8 text-primary mb-4" />
          ...
          <div class="bg-muted rounded-xl p-8">
            <div class="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <div class="text-muted-foreground">Salsa Instructor</div>
              </div>
            </div>
          ...
          <div class="bg-muted rounded-xl p-8">
            <div class="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <div class="text-muted-foreground">Bachata Performer</div>
              </div>
            </div>
            <p class="text-muted-foreground mb-4">
