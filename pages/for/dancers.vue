    ...
    :steps="[
      {
        ...
        description:
          'Sign up and create your dancer profile. Share your dance styles, experience, and social media presence.',
        class:
      ...
      },
      {
        ...
        title: 'Share & Promote',
        description:
          'Share events, classes, and services with your unique referral links on social media and with your network.',
        class:
      ...
      },
      {
        ...
        title: 'Earn Rewards',
        description:
          'Earn commission when people book through your links. Get special perks as your influence grows.',
        class:
    ...
    :testimonials="[
      {
        ...
        quote:
          'I\'ve earned over €500 in my first month just by sharing events with my students and social media followers!',
      },
      {
        title: 'David K.',
        subtitle: 'Festival Organizer',
        quote:
          'The referral system helped me fill my workshops faster and reward my loyal community members.',
      },
      {
        title: 'Maria L.',
        subtitle: 'Dance Blogger',
        quote:
          'WeDance\'s promotion tools helped me monetize my dance blog and create additional income streams.',
      },
    ]"
  />
