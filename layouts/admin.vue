...
const navigationItems = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        to: '/admin/courses/videos',
        label: 'Video Uploads',
        icon: 'lucide:video',
      },
      {
        to: '/admin/courses/drafts',
        label: 'Drafts vs Published',
  ...
  },
  {
    ...
    children: [
      ...
      {
        to: '/admin/artists/applications',
        label: 'Instructor Applications',
        icon: 'lucide:clipboard-check',
      },
      {
        to: '/admin/artists/performance',
        label: 'Performance Metrics',
        icon: 'lucide:trending-up',
      },
      {
        to: '/admin/artists/payouts',
  ...
  },
  {
    ...
    children: [
      { to: '/admin/events/', label: 'All Events', icon: 'lucide:list' },
      {
      ...
      {
        to: '/admin/events/rsvps',
        label: 'Manage RSVPs & Guest List',
        icon: 'lucide:users',
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        to: '/admin/bookings/classes',
        label: 'Class Bookings',
        icon: 'lucide:book-open',
      },
      {
        to: '/admin/bookings/festivals',
        label: 'Festival & Workshop Tickets',
        icon: 'lucide:ticket',
      },
      {
        to: '/admin/bookings/status',
        label: 'Booking Status & Refunds',
  ...
  },
  {
    ...
    children: [
      ...
      {
        to: '/admin/payments/commission',
        label: 'Commission & Fee Settings',
        icon: 'lucide:percent',
      },
      {
        to: '/admin/payments/promotions',
        label: 'Coupons / Promotions',
        icon: 'lucide:tag',
      },
      {
        to: '/admin/payments/sales',
        label: 'Sales by Course/Event/Artist',
        icon: 'lucide:trending-up',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'Reports / Flagged Accounts',
        icon: 'lucide:flag',
      },
      {
        to: '/admin/users/support',
  ...
  },
  {
    ...
    children: [
      {
        to: '/admin/venues/list',
        label: 'City & Venue Listings',
        icon: 'lucide:list',
      },
      {
        to: '/admin/venues/maps',
        label: 'Map Pins Management',
        icon: 'lucide:map',
      },
      {
        to: '/admin/venues/calendars',
        label: 'Subscribe to City Calendars',
        icon: 'lucide:calendar',
      },
      {
        to: '/admin/venues/sync',
        label: 'Location Data Sync',
        icon: 'lucide:refresh-cw',
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        to: '/admin/notifications/sequences',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'Most Watched / Booked',
        icon: 'lucide:play-circle',
      },
      {
        to: '/admin/analytics/engagement',
        label: 'Engagement KPIs',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'Terms, Privacy, Cookies',
        icon: 'lucide:file-text',
      },
      {
        to: '/admin/settings/locale',
