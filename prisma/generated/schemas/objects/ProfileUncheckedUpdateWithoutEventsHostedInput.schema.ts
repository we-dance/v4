...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateWithoutEventsHostedInput> =
  z
    .object({
      id: z
        .union([
...
export const ProfileUncheckedUpdateWithoutEventsHostedInputObjectSchema = Schema
