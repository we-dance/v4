...
const Schema: z.ZodType<Prisma.CityUncheckedCreateNestedManyWithoutCountryInput> =
  z
    .object({
      create: z
        .union([
...
export const CityUncheckedCreateNestedManyWithoutCountryInputObjectSchema =
  Schema
