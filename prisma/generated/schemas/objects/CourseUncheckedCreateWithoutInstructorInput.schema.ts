...
const Schema: z.ZodType<Prisma.CourseUncheckedCreateWithoutInstructorInput> = z
  .object({
...
export const CourseUncheckedCreateWithoutInstructorInputObjectSchema = Schema
