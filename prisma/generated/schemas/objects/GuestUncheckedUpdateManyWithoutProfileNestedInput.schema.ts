...
const Schema: z.ZodType<Prisma.GuestUncheckedUpdateManyWithoutProfileNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => GuestUpsertWithWhereUniqueWithoutProfileInputObjectSchema
          ),
          z
            .lazy(
              () => GuestUpsertWithWhereUniqueWithoutProfileInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => GuestUpdateWithWhereUniqueWithoutProfileInputObjectSchema
          ),
          z
            .lazy(
              () => GuestUpdateWithWhereUniqueWithoutProfileInputObjectSchema
...
export const GuestUncheckedUpdateManyWithoutProfileNestedInputObjectSchema =
  Schema
