...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateWithoutEventsOrganizedInput> =
  z
    .object({
      id: z
        .union([
...
export const ProfileUncheckedUpdateWithoutEventsOrganizedInputObjectSchema =
  Schema
