...
const Schema: z.ZodType<Prisma.CitySubscriberUpdateManyWithoutProfileNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CitySubscriberUpdateManyWithoutProfileNestedInputObjectSchema =
  Schema
