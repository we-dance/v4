...
const Schema: z.ZodType<Prisma.ProfileFollowerCreateNestedManyWithoutProfileInput> =
  z
    .object({
      create: z
        .union([
...
export const ProfileFollowerCreateNestedManyWithoutProfileInputObjectSchema =
  Schema
