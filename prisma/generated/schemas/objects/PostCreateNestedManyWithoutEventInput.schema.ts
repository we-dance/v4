...
const Schema: z.ZodType<Prisma.PostCreateNestedManyWithoutEventInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => PostUncheckedCreateWithoutEventInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => PostCreateOrConnectWithoutEventInputObjectSchema),
        z.lazy(() => PostCreateOrConnectWithoutEventInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
...
export const PostCreateNestedManyWithoutEventInputObjectSchema = Schema
