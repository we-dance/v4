...
const Schema: z.ZodType<Prisma.ExperienceCreateNestedManyWithoutStyleInput> = z
  .object({
    create: z
      .union([
...
export const ExperienceCreateNestedManyWithoutStyleInputObjectSchema = Schema
