...
const Schema: z.ZodType<Prisma.CourseResourceUncheckedUpdateManyWithoutCourseNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CourseResourceUncheckedUpdateManyWithoutCourseNestedInputObjectSchema =
  Schema
