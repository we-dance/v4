...
import { PostUncheckedCreateNestedManyWithoutStyleInputObjectSchema } from './PostUncheckedCreateNestedManyWithoutStyleInput.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.DanceStyleUncheckedCreateWithoutExperiencesInput> =
  z
    .object({
      ...
      events: z
        .lazy(
          () => EventUncheckedCreateNestedManyWithoutStylesInputObjectSchema
        )
        .optional(),
      videos: z
        ...
        .optional(),
      posts: z
        .lazy(() => PostUncheckedCreateNestedManyWithoutStyleInputObjectSchema)
        .optional(),
    })
    .strict()

export const DanceStyleUncheckedCreateWithoutExperiencesInputObjectSchema =
  Schema
