...
const Schema: z.ZodType<Prisma.PostUncheckedUpdateManyWithoutStyleNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PostUncheckedUpdateManyWithoutStyleNestedInputObjectSchema = Schema
