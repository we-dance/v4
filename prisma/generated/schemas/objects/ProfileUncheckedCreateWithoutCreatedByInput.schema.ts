...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateWithoutCreatedByInput> = z
  .object({
...
export const ProfileUncheckedCreateWithoutCreatedByInputObjectSchema = Schema
