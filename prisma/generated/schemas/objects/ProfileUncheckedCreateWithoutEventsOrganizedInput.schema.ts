...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateWithoutEventsOrganizedInput> =
  z
    .object({
...
export const ProfileUncheckedCreateWithoutEventsOrganizedInputObjectSchema =
  Schema
