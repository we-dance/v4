...
import { DanceStyleUpdateManyWithoutEventsNestedInputObjectSchema } from './DanceStyleUpdateManyWithoutEventsNestedInput.schema'
...
const Schema: z.ZodType<Prisma.EventUpdateWithoutOrganizerInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    updatedAt: z
      ...
      .optional(),
    styles: z
      .lazy(() => DanceStyleUpdateManyWithoutEventsNestedInputObjectSchema)
      .optional(),
    creator: z
      .lazy(
        () =>
...
export const EventUpdateWithoutOrganizerInputObjectSchema = Schema
