...
const Schema: z.ZodType<Prisma.CityUncheckedUpdateManyWithoutCountryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CityUncheckedUpdateManyWithoutCountryNestedInputObjectSchema =
  Schema
