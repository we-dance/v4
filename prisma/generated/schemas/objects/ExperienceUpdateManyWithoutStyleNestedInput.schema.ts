...
const Schema: z.ZodType<Prisma.ExperienceUpdateManyWithoutStyleNestedInput> = z
  .object({
    create: z
      .union([
...
export const ExperienceUpdateManyWithoutStyleNestedInputObjectSchema = Schema
