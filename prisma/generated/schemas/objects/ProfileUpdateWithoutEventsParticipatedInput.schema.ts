...
const Schema: z.ZodType<Prisma.ProfileUpdateWithoutEventsParticipatedInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ProfileUpdateWithoutEventsParticipatedInputObjectSchema = Schema
