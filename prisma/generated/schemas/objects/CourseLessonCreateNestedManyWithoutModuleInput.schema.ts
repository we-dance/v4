...
const Schema: z.ZodType<Prisma.CourseLessonCreateNestedManyWithoutModuleInput> =
  z
    .object({
      create: z
        .union([
...
export const CourseLessonCreateNestedManyWithoutModuleInputObjectSchema = Schema
