...
const Schema: z.ZodType<Prisma.CourseUpdateManyWithoutInstructorNestedInput> = z
  .object({
    create: z
      .union([
...
export const CourseUpdateManyWithoutInstructorNestedInputObjectSchema = Schema
