...
import { ProfileFollowerUncheckedUpdateManyWithoutFollowerNestedInputObjectSchema } from './ProfileFollowerUncheckedUpdateManyWithoutFollowerNestedInput.schema'
...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateWithoutCoursesAsinstructorInput> =
  z
    .object({
      id: z
        .union([
      ...
      eventsCreated: z
        .lazy(
          () => EventUncheckedUpdateManyWithoutCreatorNestedInputObjectSchema
        )
        .optional(),
      eventsOrganized: z
        .lazy(
      ...
      following: z
        .lazy(
          () =>
            ProfileFollowerUncheckedUpdateManyWithoutFollowerNestedInputObjectSchema
        )
        .optional(),
      cities: z
        .lazy(
      ...
      eventsParticipated: z
        .lazy(
          () => GuestUncheckedUpdateManyWithoutProfileNestedInputObjectSchema
        )
        .optional(),
      videosAdded: z
        .lazy(
...
export const ProfileUncheckedUpdateWithoutCoursesAsinstructorInputObjectSchema =
  Schema
