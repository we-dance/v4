...
const Schema: z.ZodType<Prisma.CourseLessonUncheckedUpdateManyWithoutModuleNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CourseLessonUncheckedUpdateManyWithoutModuleNestedInputObjectSchema =
  Schema
