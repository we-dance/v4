...
const Schema: z.ZodType<Prisma.VideoUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => VideoUpdateManyWithWhereWithoutCreatedByInputObjectSchema
          ),
          z
            .lazy(
              () => VideoUpdateManyWithWhereWithoutCreatedByInputObjectSchema
...
export const VideoUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema
