...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateWithoutEventsHostedInput> =
  z
    .object({
...
export const ProfileUncheckedCreateWithoutEventsHostedInputObjectSchema = Schema
