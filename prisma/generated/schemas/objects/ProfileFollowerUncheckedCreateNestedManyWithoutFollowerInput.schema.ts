...
const Schema: z.ZodType<Prisma.ProfileFollowerUncheckedCreateNestedManyWithoutFollowerInput> =
  z
    .object({
      create: z
        .union([
...
export const ProfileFollowerUncheckedCreateNestedManyWithoutFollowerInputObjectSchema =
  Schema
