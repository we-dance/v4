...
const Schema: z.ZodType<Prisma.ProfileFollowerUncheckedUpdateManyWithoutFollowerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProfileFollowerUncheckedUpdateManyWithoutFollowerNestedInputObjectSchema =
  Schema
