...
const Schema: z.ZodType<Prisma.DanceStyleUncheckedCreateNestedManyWithoutEventsInput> =
  z
    .object({
      create: z
        .union([
...
export const DanceStyleUncheckedCreateNestedManyWithoutEventsInputObjectSchema =
  Schema
