...
const Schema: z.ZodType<Prisma.CourseModuleUpdateManyWithoutCourseNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CourseModuleUpdateManyWithoutCourseNestedInputObjectSchema = Schema
