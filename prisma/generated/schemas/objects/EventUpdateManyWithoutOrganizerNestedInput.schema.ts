...
const Schema: z.ZodType<Prisma.EventUpdateManyWithoutOrganizerNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        ...
        z
          .lazy(() => EventUpdateManyWithWhereWithoutOrganizerInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const EventUpdateManyWithoutOrganizerNestedInputObjectSchema = Schema
