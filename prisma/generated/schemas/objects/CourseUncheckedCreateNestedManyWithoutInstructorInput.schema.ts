...
const Schema: z.ZodType<Prisma.CourseUncheckedCreateNestedManyWithoutInstructorInput> =
  z
    .object({
      create: z
        .union([
...
export const CourseUncheckedCreateNestedManyWithoutInstructorInputObjectSchema =
  Schema
