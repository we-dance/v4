...
const Schema: z.ZodType<Prisma.DanceStyleWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => DanceStyleWhereInputObjectSchema),
        z.lazy(() => DanceStyleWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
    ...
    experiences: z
      ...
      .optional(),
    videos: z.lazy(() => VideoListRelationFilterObjectSchema).optional(),
    posts: z.lazy(() => PostListRelationFilterObjectSchema).optional(),
  })
  .strict()

export const DanceStyleWhereInputObjectSchema = Schema
