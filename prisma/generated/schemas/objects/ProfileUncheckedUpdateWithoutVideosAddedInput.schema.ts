...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateWithoutVideosAddedInput> =
  z
    .object({
      id: z
        .union([
...
export const ProfileUncheckedUpdateWithoutVideosAddedInputObjectSchema = Schema
