...
const Schema: z.ZodType<Prisma.ProfileUpsertWithWhereUniqueWithoutCreatedByInput> =
  z
    .object({
...
export const ProfileUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema =
  Schema
