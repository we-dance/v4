...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutProfilesCreatedInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutProfilesCreatedInputObjectSchema = Schema
