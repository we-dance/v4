...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateWithoutFollowersInput> = z
  .object({
...
export const ProfileUncheckedCreateWithoutFollowersInputObjectSchema = Schema
