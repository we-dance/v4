...
const Schema: z.ZodType<Prisma.CourseResourceUncheckedCreateNestedManyWithoutCourseInput> =
  z
    .object({
      create: z
        .union([
...
export const CourseResourceUncheckedCreateNestedManyWithoutCourseInputObjectSchema =
  Schema
