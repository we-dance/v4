...
const Schema: z.ZodType<Prisma.CitySubscriberUncheckedCreateNestedManyWithoutCityInput> =
  z
    .object({
      create: z
        .union([
...
export const CitySubscriberUncheckedCreateNestedManyWithoutCityInputObjectSchema =
  Schema
