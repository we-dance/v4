...
const Schema: z.ZodType<Prisma.DanceStyleUpdateManyWithoutEventsNestedInput> = z
  .object({
    create: z
      .union([
...
export const DanceStyleUpdateManyWithoutEventsNestedInputObjectSchema = Schema
