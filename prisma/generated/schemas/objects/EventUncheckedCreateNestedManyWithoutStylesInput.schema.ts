...
const Schema: z.ZodType<Prisma.EventUncheckedCreateNestedManyWithoutStylesInput> =
  z
    .object({
      create: z
        .union([
...
export const EventUncheckedCreateNestedManyWithoutStylesInputObjectSchema =
  Schema
