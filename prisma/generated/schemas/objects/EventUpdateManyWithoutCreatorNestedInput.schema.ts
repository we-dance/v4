...
const Schema: z.ZodType<Prisma.EventUpdateManyWithoutCreatorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => EventUpsertWithWhereUniqueWithoutCreatorInputObjectSchema),
        z
          .lazy(() => EventUpsertWithWhereUniqueWithoutCreatorInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => EventUpdateWithWhereUniqueWithoutCreatorInputObjectSchema),
        z
          .lazy(() => EventUpdateWithWhereUniqueWithoutCreatorInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const EventUpdateManyWithoutCreatorNestedInputObjectSchema = Schema
