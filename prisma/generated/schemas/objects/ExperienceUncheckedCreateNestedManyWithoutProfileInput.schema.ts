...
const Schema: z.ZodType<Prisma.ExperienceUncheckedCreateNestedManyWithoutProfileInput> =
  z
    .object({
      create: z
        .union([
...
export const ExperienceUncheckedCreateNestedManyWithoutProfileInputObjectSchema =
  Schema
