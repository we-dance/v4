...
const Schema: z.ZodType<Prisma.CitySubscriberUncheckedUpdateManyWithoutCityNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CitySubscriberUncheckedUpdateManyWithoutCityNestedInputObjectSchema =
  Schema
