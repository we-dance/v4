...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateWithoutCoursesAsinstructorInput> =
  z
    .object({
      ...
      eventsCreated: z
        .lazy(
          () => EventUncheckedCreateNestedManyWithoutCreatorInputObjectSchema
        )
        .optional(),
      eventsOrganized: z
        .lazy(
      ...
      eventsParticipated: z
        .lazy(
          () => GuestUncheckedCreateNestedManyWithoutProfileInputObjectSchema
        )
        .optional(),
      videosAdded: z
        .lazy(
...
export const ProfileUncheckedCreateWithoutCoursesAsinstructorInputObjectSchema =
  Schema
