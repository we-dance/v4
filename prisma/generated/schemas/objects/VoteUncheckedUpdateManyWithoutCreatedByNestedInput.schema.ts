...
const Schema: z.ZodType<Prisma.VoteUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => VoteUpdateManyWithWhereWithoutCreatedByInputObjectSchema
          ),
          z
            .lazy(
              () => VoteUpdateManyWithWhereWithoutCreatedByInputObjectSchema
...
export const VoteUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema
