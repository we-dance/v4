...
const Schema: z.ZodType<Prisma.CitySubscriberUncheckedCreateNestedManyWithoutProfileInput> =
  z
    .object({
      create: z
        .union([
...
export const CitySubscriberUncheckedCreateNestedManyWithoutProfileInputObjectSchema =
  Schema
