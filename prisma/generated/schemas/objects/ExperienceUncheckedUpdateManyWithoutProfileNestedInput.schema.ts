...
const Schema: z.ZodType<Prisma.ExperienceUncheckedUpdateManyWithoutProfileNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExperienceUncheckedUpdateManyWithoutProfileNestedInputObjectSchema =
  Schema
