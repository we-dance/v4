...
import { EventCreateNestedManyWithoutCreatorInputObjectSchema } from './EventCreateNestedManyWithoutCreatorInput.schema'
...
const Schema: z.ZodType<Prisma.ProfileCreateWithoutCoursesAsinstructorInput> = z
  .object({
    ...
    posts: z
      ...
      .optional(),
    eventsCreated: z
      .lazy(() => EventCreateNestedManyWithoutCreatorInputObjectSchema)
      .optional(),
    eventsOrganized: z
...
export const ProfileCreateWithoutCoursesAsinstructorInputObjectSchema = Schema
