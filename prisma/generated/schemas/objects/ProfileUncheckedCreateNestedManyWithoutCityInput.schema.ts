...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateNestedManyWithoutCityInput> =
  z
    .object({
      create: z
        .union([
...
export const ProfileUncheckedCreateNestedManyWithoutCityInputObjectSchema =
  Schema
