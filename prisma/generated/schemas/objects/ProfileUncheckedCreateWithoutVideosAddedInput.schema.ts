...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateWithoutVideosAddedInput> =
  z
    .object({
...
export const ProfileUncheckedCreateWithoutVideosAddedInputObjectSchema = Schema
