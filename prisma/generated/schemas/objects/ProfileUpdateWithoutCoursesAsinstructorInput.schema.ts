...
import { ProfileFollowerUpdateManyWithoutProfileNestedInputObjectSchema } from './ProfileFollowerUpdateManyWithoutProfileNestedInput.schema'
...
const Schema: z.ZodType<Prisma.ProfileUpdateWithoutCoursesAsinstructorInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    followers: z
      .lazy(
        () => ProfileFollowerUpdateManyWithoutProfileNestedInputObjectSchema
      )
      .optional(),
    following: z
      .lazy(
...
export const ProfileUpdateWithoutCoursesAsinstructorInputObjectSchema = Schema
