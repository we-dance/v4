...
const Schema: z.ZodType<Prisma.EventUncheckedUpdateManyWithoutStylesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => EventUpsertWithWhereUniqueWithoutStylesInputObjectSchema
          ),
          z
            .lazy(
              () => EventUpsertWithWhereUniqueWithoutStylesInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => EventUpdateWithWhereUniqueWithoutStylesInputObjectSchema
          ),
          z
            .lazy(
              () => EventUpdateWithWhereUniqueWithoutStylesInputObjectSchema
...
export const EventUncheckedUpdateManyWithoutStylesNestedInputObjectSchema =
  Schema
