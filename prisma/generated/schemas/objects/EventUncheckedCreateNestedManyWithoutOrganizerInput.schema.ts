...
const Schema: z.ZodType<Prisma.EventUncheckedCreateNestedManyWithoutOrganizerInput> =
  z
    .object({
      create: z
        .union([
...
export const EventUncheckedCreateNestedManyWithoutOrganizerInputObjectSchema =
  Schema
