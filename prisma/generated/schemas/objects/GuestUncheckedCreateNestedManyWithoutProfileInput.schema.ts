...
const Schema: z.ZodType<Prisma.GuestUncheckedCreateNestedManyWithoutProfileInput> =
  z
    .object({
      create: z
        .union([
...
export const GuestUncheckedCreateNestedManyWithoutProfileInputObjectSchema =
  Schema
