...
const Schema: z.ZodType<Prisma.CourseModuleUncheckedCreateNestedManyWithoutCourseInput> =
  z
    .object({
      create: z
        .union([
...
export const CourseModuleUncheckedCreateNestedManyWithoutCourseInputObjectSchema =
  Schema
