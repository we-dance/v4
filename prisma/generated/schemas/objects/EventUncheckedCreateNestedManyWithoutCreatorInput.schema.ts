...
const Schema: z.ZodType<Prisma.EventUncheckedCreateNestedManyWithoutCreatorInput> =
  z
    .object({
      create: z
        .union([
...
export const EventUncheckedCreateNestedManyWithoutCreatorInputObjectSchema =
  Schema
