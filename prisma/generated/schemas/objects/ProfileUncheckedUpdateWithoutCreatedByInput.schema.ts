...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateWithoutCreatedByInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ProfileUncheckedUpdateWithoutCreatedByInputObjectSchema = Schema
