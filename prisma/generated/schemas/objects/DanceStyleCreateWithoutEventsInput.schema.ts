import { z } from 'zod'
import { ExperienceCreateNestedManyWithoutStyleInputObjectSchema } from './ExperienceCreateNestedManyWithoutStyleInput.schema'
...
const Schema: z.ZodType<Prisma.DanceStyleCreateWithoutEventsInput> = z
  .object({
    name: z.string(),
    hashtag: z.string(),
    ...
    experiences: z
      .lazy(() => ExperienceCreateNestedManyWithoutStyleInputObjectSchema)
      .optional(),
    videos: z
...
export const DanceStyleCreateWithoutEventsInputObjectSchema = Schema
