...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateManyWithoutCityNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ProfileUpsertWithWhereUniqueWithoutCityInputObjectSchema
          ),
          z
            .lazy(
              () => ProfileUpsertWithWhereUniqueWithoutCityInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => ProfileUpdateWithWhereUniqueWithoutCityInputObjectSchema
          ),
          z
            .lazy(
              () => ProfileUpdateWithWhereUniqueWithoutCityInputObjectSchema
...
export const ProfileUncheckedUpdateManyWithoutCityNestedInputObjectSchema =
  Schema
