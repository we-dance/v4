...
const Schema: z.ZodType<Prisma.ProfileUncheckedCreateWithoutEventsParticipatedInput> =
  z
    .object({
...
export const ProfileUncheckedCreateWithoutEventsParticipatedInputObjectSchema =
  Schema
