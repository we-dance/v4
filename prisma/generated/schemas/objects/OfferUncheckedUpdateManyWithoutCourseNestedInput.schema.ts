...
const Schema: z.ZodType<Prisma.OfferUncheckedUpdateManyWithoutCourseNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => OfferUpsertWithWhereUniqueWithoutCourseInputObjectSchema
          ),
          z
            .lazy(
              () => OfferUpsertWithWhereUniqueWithoutCourseInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => OfferUpdateWithWhereUniqueWithoutCourseInputObjectSchema
          ),
          z
            .lazy(
              () => OfferUpdateWithWhereUniqueWithoutCourseInputObjectSchema
...
export const OfferUncheckedUpdateManyWithoutCourseNestedInputObjectSchema =
  Schema
