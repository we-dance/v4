...
const Schema: z.ZodType<Prisma.ProfileFollowerUncheckedUpdateManyWithoutProfileNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProfileFollowerUncheckedUpdateManyWithoutProfileNestedInputObjectSchema =
  Schema
