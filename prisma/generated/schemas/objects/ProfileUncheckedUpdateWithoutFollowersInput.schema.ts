...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateWithoutFollowersInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ProfileUncheckedUpdateWithoutFollowersInputObjectSchema = Schema
